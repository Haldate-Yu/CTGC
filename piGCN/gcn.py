...
if __name__ == '__main__':
    ...
    for run in range(10):
        ...
        # dataset, data = load_others(dataname=args.dataset, path='./data')
        ...
        # model = SimpleGCN(dataset=dataset, hidden=16, num_layers=2)
        model = GCN(dataset=dataset, hidden=16, num_layers=args.degree) 
        # 转换为cpu或cuda格式
        # print(args.cuda)
        if args.cuda:
