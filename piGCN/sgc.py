...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight', '-w', type=float, default='1e-5')
    ...
    for run in range(10):
        ...
        print(data)
        # 实例化模型
        # model = SimpleGCN(dataset=dataset, hidden=16, num_layers=8)
        model = piSGC(dataset=dataset, hidden=16, num_layers=8, k=args.khop)
