...
if args.dataset in {'cora', 'citeseer', 'pubmed'}:
    ...
    adj, features, labels, idx_train, idx_val, idx_test = load_citation(args.dataset, args, args.normalization,
                                                                        args.cuda,
                                                                        data_path)
...
logger(args, acc_val, acc_test, precompute_time, train_time)
